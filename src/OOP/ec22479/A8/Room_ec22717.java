...
class Room_ec22717 extends Room {
    public Direction visit(Visitor visitor, Direction directionFrom) throws InterruptedException {
        A8.a8.imagePanel.setIcon(A8.a8.fahimsRoom);
    ...
    Direction ChooseAction(boolean hasInspectedShelf, boolean hasOpenedBox, boolean lightOn, Visitor visitor, Direction directionFrom) throws InterruptedException {
    ...
    Direction Leave(Visitor visitor, boolean lightOn) throws InterruptedException {
        char[] fourOptions = {'a', 'b', 'c', 'd'};
