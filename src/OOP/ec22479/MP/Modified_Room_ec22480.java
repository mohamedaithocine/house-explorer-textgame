...
public class Modified_Room_ec22480 extends Room {
	...
	public Direction visit(Visitor visitor, Direction from)
	{
		if (!hasTmansWisdomTooth)
		{
			...
			{
				MP_ec22479.changeIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("images\\zubairsRoom\\zubairDiscount.jpg"))));
			...
			{
				MP_ec22479.changeIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("images\\zubairsRoom\\zubairShocked.jpg"))));
				visitor.tell("""
						Oh what's this.
		...
		else 
		{
			...
			MP_ec22479.changeIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("images\\zubairsRoom\\brokenShop.jpg"))));
